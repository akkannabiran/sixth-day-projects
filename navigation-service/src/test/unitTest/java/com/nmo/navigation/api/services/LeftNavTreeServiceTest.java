...
public class LeftNavTreeServiceTest {
    ...
    public void shouldReturnLeftNavTreeForNavPathWithMultipleCategoriesIfFoundInRepository() {
        ...
        when(leftNavTreeMapper.mapElasticSearchLeftNavToWebLeftNav(leftNavDocument, US_COUNTRY_CODE)).thenReturn(getTestLeftNavTree());

        LeftNavTree result = leftNavTreeService.getLeftNavTreeByNavPath(NAV_PATH_WITH_MULTIPLE_CATEGORIES, US_COUNTRY_CODE, SOURCE_LEFT_NAV, null);
    ...
    public void shouldReturnTestLeftNavTreeForNavPathWithMultipleCategoriesIfFoundInRepositoryForNavKeyGroupB() {
        ...
        when(leftNavTreeMapper.mapElasticSearchLeftNavToWebLeftNav(leftNavDocument, US_COUNTRY_CODE)).thenReturn(expectedLeftNavTree);

        LeftNavTree result = leftNavTreeService.getLeftNavTreeByNavPath("cat123_cat2", US_COUNTRY_CODE, SOURCE_LEFT_NAV, "B");
    ...
    public void shouldReturnLeftNavTreeForNavPathWithSingleCategoryIfFoundInRepository() {
        ...
        LeftNavTree result = leftNavTreeService.getLeftNavTreeByNavPath(NAV_PATH, US_COUNTRY_CODE, SOURCE_LEFT_NAV, "");
    ...
    public void shouldReturnTestLeftNavTreeForNavPathWithSingleCategoryIfFoundInRepositoryForNavKeyGroupB() {
        ...
        LeftNavTree result = leftNavTreeService.getLeftNavTreeByNavPath("cat123", US_COUNTRY_CODE, SOURCE_LEFT_NAV, "");
    ...
    public void shouldReturnEmptyResponseForNavPathWithMultipleCategoriesIfTheyAreNotFoundInRepository() {
        LeftNavDocument leftNavDocument = getTestLeftNavDocument();
        when(leftNavRepository.getLeftNavDocument(NAV_PATH_WITH_MULTIPLE_CATEGORIES)).thenReturn(leftNavDocument);
        when(leftNavTreeMapper.mapElasticSearchLeftNavToWebLeftNav(leftNavDocument, US_COUNTRY_CODE)).thenReturn(null);

        leftNavTreeService.getLeftNavTreeByNavPath(NAV_PATH_WITH_MULTIPLE_CATEGORIES, US_COUNTRY_CODE, SOURCE_LEFT_NAV, null);
    }
    ...
    public void shouldReturnEmptyResponseForNavPathWithSingleCategoryIfTheyAreNotFoundInRepository() {
        ...
        leftNavTreeService.getLeftNavTreeByNavPath(NAV_PATH, US_COUNTRY_CODE, SOURCE_LEFT_NAV, null);
    }
    ...
    public void shouldReturnDriveToLeftNavIfSourceIsNotLeftNavAndDocumentHasDriveTo() {
        ...
        when(leftNavTreeMapper.mapElasticSearchLeftNavToWebLeftNav(driveToLeftNavDocument, US_COUNTRY_CODE)).thenReturn(getLeftNavTreeWithDriveTo());

        LeftNavTree tree = leftNavTreeService.getLeftNavTreeByNavPath(NAV_PATH_WITH_MULTIPLE_CATEGORIES, US_COUNTRY_CODE, SOURCE_TOP_NAV, null);
