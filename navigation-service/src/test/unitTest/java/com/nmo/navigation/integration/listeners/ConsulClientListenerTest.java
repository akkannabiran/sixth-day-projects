package com.sixthday.navigation.integration.listeners;
...
public class ConsulClientListenerTest {
    ...
    @Test
    @SneakyThrows
    public void shouldNotAddListenerWhenAlreadyAdded() {
        ...
        Class name = Class.forName("com.sixthday.navigation.integration.listeners.ConsulClientListener");
