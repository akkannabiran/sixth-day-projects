...
import static com.sixthday.store.config.Constants.Logging.MDC_CONTEXT_ID;
import static com.sixthday.store.config.Constants.Logging.MDC_DESTINATION_PROPERTY;
import static com.sixthday.store.config.Constants.Logging.MDC_MESSAGE_ID;
import static com.sixthday.store.config.Constants.Logging.MDC_MESSAGE_TYPE;
import static com.sixthday.store.config.Constants.Logging.MDC_ORIGIN_TIMESTAMP;
import static com.sixthday.store.config.Constants.Logging.MDC_RESOURCE_PROPERTY;
import static com.sixthday.store.config.Constants.Logging.MDC_SOURCE_PROPERTY;
